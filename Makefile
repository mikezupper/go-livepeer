...
docker:
	docker buildx build --build-arg='BUILD_TAGS=mainnet,experimental' -t tztcloud/go-livepeer:v0.7.9-ai.3-v0.0.10-livepeer-cloud-job-tester   -f docker/Dockerfile .
